The archive WGCCM_three_link_walker_example contains MATLAB scripts to
simulate a three-link, planar biped walker.
...
with no arguments at the MATLAB command prompt.
