...
% HZD
load Response20-May-2016_day_l040h00.mat % for initial states
% load Response28-Sep-2016_day_l0_40_l1_40_periodic
...
% end
controller.CBF_hd=zeros(25,1);
controller.CBF_hd(2)=0.2; 
controller.CBF_hd(3)=0.2; 
controller.CBF_hd(end-2)=-0.2;
controller.CBF_hd(end-1)=-0.2;

controller.CBF_ld=[0.4; 0.4; 0.4; 0.9;0.54;0.54;0.61;0.93;0.98;0.99;0.43;
    0.89;0.69;0.35;0.73;0.85;0.47;0.49;0.49;0.78;0.7;0.45;0.4;0.4; 0.4];

ld_set=controller.CBF_ld
hd_set=controller.CBF_hd
controller.stone_size=0.2/2;
...
stepHeight = -0*ones(1,length(stepLength));

stepHeight(stepLength<=controller.stone_size)=0;
stepHeight(stepLength<=-controller.stone_size)=-0.5*0;
...
[response,xMinus,y,dy,data,ls_last] = sys.simulate([0 2], x0, controller,...
	'initialMode', 'ss',...
	'controller',u,...
	'maxModes',Nstep,...
	'solver','ode15s',...
