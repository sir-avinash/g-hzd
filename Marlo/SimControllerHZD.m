classdef SimControllerHZD < handle
	% PUBLIC PROPERTIES
	properties
		% Step Duration (s0
        ...
        l0_update@double = 0.5; 
        l1_update@double = 0.5;
        e_fp_set@double=zeros(20,1);
    end
	...
	methods
		...
		function  [u,x,xdot,data,ls_last] = HZDfeedbackControl(obj,t,x,xdot,...
            ...
            if obj.N_1step ~= Nstep
                ...
                obj.e_fp_set(Nstep)=e_fp;
                e_fpSet=obj.e_fp_set
            end
            ...
            HAlpha = interpolateRoughGround4(hAlphaSet,h1Set,h1, h0Set, h0,l1Set,obj.l1_update, l0Set, obj.l0_update);
            HAlpha_theta = interpolateRoughGround4(thetaSet,h1Set,h1, h0Set, h0,l1Set,obj.l1_update, l0Set, obj.l0_update);
