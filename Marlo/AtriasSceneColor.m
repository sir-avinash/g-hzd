...
classdef AtriasSceneColor < Scene
  ...
  % PUBLIC METHODS ========================================================
	methods
		function obj = AtriasSceneColor(sys, response)
...
% 			obj.ground.update;
        ...
        [g mTotal L1 L2 L3 L4 m1 m2 m3 m4 Jcm1 Jcm2 Jcm3 Jcm4 ellzcm1 ...
         ...
         Jgear1  Jgear2 R1  R2] = modelParametersAtrias_v06;
			...
			obj.torso = RoundedSquare(LT*1.2 + 2*R, 5*R, R,'g');
%             obj.torso = RoundedSquare(LT*0.8 + 2*R, 5*R, R);
% 			obj.lLegA1 = RoundedSquare(L1 + 2*r, 2*r, r,'r');
			obj.lLegA2 = RoundedSquare(L4 + 2*r, 2*r, r,'r');
			obj.lLegB1 = RoundedSquare(L3 + 2*r, 2*r, r,'r');
% 			obj.lLegB2 = RoundedSquare(L2 + 2*r, 2*r, r,'r');
% 			obj.rLegA1 = RoundedSquare(L1 + 2*r, 2*r, r,'b');
			obj.rLegA2 = RoundedSquare(L4 + 2*r, 2*r, r,'b');
			obj.rLegB1 = RoundedSquare(L3 + 2*r, 2*r, r,'b');
% 			obj.rLegB2 = RoundedSquare(L2 + 2*r, 2*r, r,'b');
% 			obj.lActA = RoundedSquare(0.25 + 2*r, 2*r, r,'r');
% 			obj.lActB = RoundedSquare(0.25 + 2*r, 2*r, r,'r');
% 			obj.rActA = RoundedSquare(0.25 + 2*r, 2*r, r,'b');
% 			obj.rActB = RoundedSquare(0.25 + 2*r, 2*r, r,'b');
...
% 			xlim(obj.axes, px + [-w, w]/2); % moving screen
% %             xlim(obj.axes, 2.5 + [-w, w]/2); % fixed screen

			w = 25;%7;
			ylim(obj.axes, pz/pz - 0.5 + ([-w, w])*720/1280/2);
			xlim(obj.axes, px + [-1, w]/2); % moving screen
