function [g mTotal L1 L2 L3 L4 m1 m2 m3 m4 Jcm1 Jcm2 Jcm3 Jcm4 ellzcm1 ellzcm2 ellzcm3 ellzcm4 ellycm1 ellycm2 ellycm3 ellycm4 LT mT JcmT ellzcmT ellycmT mH JcmH K1 K2 Kd1 Kd2 Jrotor1 Jrotor2 Jgear1  Jgear2 R1  R2 Kfric_HarmonicDrive] = modelParametersAtrias_massLess
%
%
...
[g mTotal m1 m2 m3 m4 mH mT L1 L2 L3 L4 LT W] = modelParametersAtriasMassLessLeg;
...
% massLess
Jcm1 = 1e-2; % kg m^2 Lxx of shin (L1) and spring
Jcm2 = 1e-2; % thigh (L2) and spring
Jcm3 = 1e-2; % Lxx from four bar linkage.
Jcm4 = 1e-2;

ellzcm1 = 0.2; % m shin (L1)
ellzcm2 = 0.2; % Z from thigh. (L2)
ellzcm3 = 0.2; % Z from Four bar linkage. (L3)
ellzcm4 = 0.2; % Z from Lower leg. (L4)
ellycm1 = 0; % Y from shin. (L1)
ellycm2 = 0; % Y from thigh. (L2)
ellycm3 = 0;
ellycm4 = 0;
