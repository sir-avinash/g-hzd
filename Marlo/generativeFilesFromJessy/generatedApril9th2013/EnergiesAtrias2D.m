...
KE(1,1)=(m3*(dqT*(L2*sin(q2 + qT) - L1*sin(q1 + qT) + L4*...
         ...
         sin(q1 + qT)))^2)/2 + (m3*(dq2L*(ellycm3*cos(q2L + qT) - ellzcm3*...
         sin(q2L + qT)) + dqT*(L2*sin(q2 + qT) + L4*sin(q1 + qT) - L1*...
         sin(q1L + qT) + ellycm3*cos(q2L + qT) - ellzcm3*...
         sin(q2L + qT)) + L2*dq2*sin(q2 + qT) + L4*dq1*sin(q1 + qT) - L1*...
         dq1L*sin(q1L + qT))^2)/2 + (m4*(dq1L*(ellycm4*...
         cos(q1L + qT) - ellzcm4*sin(q1L + qT)) + dqT*(L2*...
         sin(q2 + qT) + L4*sin(q1 + qT) - L2*sin(q2L + qT) + ellycm4*...
         cos(q1L + qT) - ellzcm4*sin(q1L + qT)) + L2*dq2*...
         sin(q2 + qT) + L4*dq1*sin(q1 + qT) - L2*dq2L*...
         sin(q2L + qT))^2)/2 + (Jcm1*(dq1 + dqT)^2)/2 + (Jcm2*...
         ...
         dq1*sin(q1 + qT))^2)/2 + (m3*(dq2*(ellzcm3*cos(q2 + qT) - L2*...
         ...
         m4 + ellzcm4^2*m4 - 2*L4*ellzcm4*m4))/2 + (m3*(dq2L*(ellzcm3*...
         cos(q2L + qT) + ellycm3*sin(q2L + qT)) + dqT*(L1*...
         cos(q1L + qT) - L4*cos(q1 + qT) - L2*cos(q2 + qT) + ellzcm3*...
         cos(q2L + qT) + ellycm3*sin(q2L + qT)) - L2*dq2*...
         cos(q2 + qT) - L4*dq1*cos(q1 + qT) + L1*dq1L*...
         cos(q1L + qT))^2)/2 + (m4*(dq1L*(ellzcm4*cos(q1L + qT) + ellycm4*...
         sin(q1L + qT)) + dqT*(L2*cos(q2L + qT) - L4*cos(q1 + qT) - L2*...
         cos(q2 + qT) + ellzcm4*cos(q1L + qT) + ellycm4*...
         sin(q1L + qT)) - L2*dq2*cos(q2 + qT) - L4*dq1*cos(q1 + qT) + L2*...
         dq2L*cos(q2L + qT))^2)/2 + (Jrotor1*(dqT + R1*...
...
KE3L=zeros(1,1);
KE3L(1,1)=(m3*(dq2L*(ellycm3*cos(q2L + qT) - ellzcm3*...
         sin(q2L + qT)) + dqT*(L2*sin(q2 + qT) + L4*sin(q1 + qT) - L1*...
         sin(q1L + qT) + ellycm3*cos(q2L + qT) - ellzcm3*...
         sin(q2L + qT)) + L2*dq2*sin(q2 + qT) + L4*dq1*sin(q1 + qT) - L1*...
         dq1L*sin(q1L + qT))^2)/2 + (Jcm3*(dq2L + dqT)^2)/2 + (m3*(dq2L*...
         (ellzcm3*cos(q2L + qT) + ellycm3*sin(q2L + qT)) + dqT*(L1*...
         cos(q1L + qT) - L4*cos(q1 + qT) - L2*cos(q2 + qT) + ellzcm3*...
         cos(q2L + qT) + ellycm3*sin(q2L + qT)) - L2*dq2*...
         cos(q2 + qT) - L4*dq1*cos(q1 + qT) + L1*dq1L*cos(q1L + qT))^2)/2;
KE4L=zeros(1,1);
KE4L(1,1)=(m4*(dq1L*(ellycm4*cos(q1L + qT) - ellzcm4*...
         sin(q1L + qT)) + dqT*(L2*sin(q2 + qT) + L4*sin(q1 + qT) - L2*...
         sin(q2L + qT) + ellycm4*cos(q1L + qT) - ellzcm4*...
         sin(q1L + qT)) + L2*dq2*sin(q2 + qT) + L4*dq1*sin(q1 + qT) - L2*...
         dq2L*sin(q2L + qT))^2)/2 + (Jcm4*(dq1L + dqT)^2)/2 + (m4*(dq1L*...
         (ellzcm4*cos(q1L + qT) + ellycm4*sin(q1L + qT)) + dqT*(L2*...
         cos(q2L + qT) - L4*cos(q1 + qT) - L2*cos(q2 + qT) + ellzcm4*...
         cos(q1L + qT) + ellycm4*sin(q1L + qT)) - L2*dq2*...
         cos(q2 + qT) - L4*dq1*cos(q1 + qT) + L2*dq2L*cos(q2L + qT))^2)/2;
KEm1L=zeros(1,1);
