function [D,C,G,B,B_HarmonicDrive]= LagrangeModelAtrias2D(q,dq)
%%%%%%  LagrangeModelAtrias2D.m
%%%%  23-Nov-2015 16:52:25
%%%%
%%%% Authors(s): Griffin version of Grizzle code
%%%%
%%%%
%%%% Model NOTATION: Spong and Vidyasagar, page 142, Eq. (6.3.12) (equation changed to removing DampingSpringTorque)
...
%%%%
D=zeros(5,5)*q(1);
D(1,1)=2*Jcm1 + 2*Jcm2 + 2*Jcm3 + 2*Jcm4 + JcmH + JcmT + 2*...
         Jgear1 + 2*Jgear2 + 2*Jrotor1 + 2*Jrotor2 + m1*(L2*...
         cos(q2 + qT) + L4*cos(q1 + qT) - ellzcm1*cos(q1 + qT) - ellycm1*...
         sin(q1 + qT))^2 + m2*(L2*cos(q2 + qT) + L4*...
         cos(q1 + qT) - ellzcm2*cos(q2 + qT) - ellycm2*...
         sin(q2 + qT))^2 + m1*(L2*cos(q2 + qT) + L4*...
         cos(q1 + qT) - ellzcm1*cos(q1L + qT) - ellycm1*...
         sin(q1L + qT))^2 + m2*(L2*cos(q2 + qT) + L4*...
         cos(q1 + qT) - ellzcm2*cos(q2L + qT) - ellycm2*...
         sin(q2L + qT))^2 + m1*(L2*sin(q2 + qT) + L4*...
         sin(q1 + qT) + ellycm1*cos(q1 + qT) - ellzcm1*...
         sin(q1 + qT))^2 + m2*(L2*sin(q2 + qT) + L4*...
         sin(q1 + qT) + ellycm2*cos(q2 + qT) - ellzcm2*...
         sin(q2 + qT))^2 + m1*(L2*sin(q2 + qT) + L4*...
         sin(q1 + qT) + ellycm1*cos(q1L + qT) - ellzcm1*...
         sin(q1L + qT))^2 + m2*(L2*sin(q2 + qT) + L4*...
         sin(q1 + qT) + ellycm2*cos(q2L + qT) - ellzcm2*...
         sin(q2L + qT))^2 + m3*(L1*cos(q1 + qT) - L2*cos(q2 + qT) - L4*...
         cos(q1 + qT) + ellzcm3*cos(q2 + qT) + ellycm3*...
         sin(q2 + qT))^2 + m3*(L1*cos(q1L + qT) - L4*cos(q1 + qT) - L2*...
         cos(q2 + qT) + ellzcm3*cos(q2L + qT) + ellycm3*...
         sin(q2L + qT))^2 + m4*(L2*cos(q2L + qT) - L4*cos(q1 + qT) - L2*...
         cos(q2 + qT) + ellzcm4*cos(q1L + qT) + ellycm4*...
         sin(q1L + qT))^2 + mT*(L2*cos(q2 + qT) + L4*...
         cos(q1 + qT) - ellzcmT*cos(qT) - ellycmT*sin(qT))^2 + L4^2*...
         m4 + L2^2*mH + L4^2*mH + mT*(L2*sin(q2 + qT) + L4*...
         sin(q1 + qT) + ellycmT*cos(qT) - ellzcmT*sin(qT))^2 + m3*(L2*...
         sin(q2 + qT) - L1*sin(q1 + qT) + L4*sin(q1 + qT) + ellycm3*...
         cos(q2 + qT) - ellzcm3*sin(q2 + qT))^2 + m3*(L2*...
         sin(q2 + qT) + L4*sin(q1 + qT) - L1*sin(q1L + qT) + ellycm3*...
         cos(q2L + qT) - ellzcm3*sin(q2L + qT))^2 + m4*(L2*...
         sin(q2 + qT) + L4*sin(q1 + qT) - L2*sin(q2L + qT) + ellycm4*...
         cos(q1L + qT) - ellzcm4*sin(q1L + qT))^2 + ellycm4^2*...
         m4 + ellzcm4^2*m4 - 2*L4*ellzcm4*m4 + 2*L2*L4*mH*cos(q1 - q2);
D(1,2)=Jcm1 + Jcm4 + Jgear1 + L1^2*m3 + 2*L4^2*m1 + 2*L4^2*...
...
D(1,3)=Jcm2 + Jcm3 + Jgear2 + 2*L2^2*m1 + 2*L2^2*m2 + 2*L2^2*...
         ...
         sin(q2 - q1L);
D(1,4)=Jcm1 + Jcm4 + Jgear1 + L1^2*m3 + ellycm1^2*m1 + ellzcm1^2*...
...
D(1,5)=Jcm2 + Jcm3 + Jgear2 + L2^2*m4 + ellycm2^2*m2 + ellzcm2^2*...
         m2 + ellycm3^2*m3 + ellzcm3^2*m3 + Jrotor2*R2 - L2^2*m4*...
         ...
         sin(q1L - q2L) + L2*ellycm4*m4*sin(q1L - q2L);
D(2,1)=Jcm1 + Jcm4 + Jgear1 + L1^2*m3 + 2*L4^2*m1 + 2*L4^2*...
         m2 + 2*L4^2*m3 + 2*L4^2*m4 + L4^2*mH + L4^2*mT + ellycm1^2*...
         m1 + ellzcm1^2*m1 + ellycm4^2*m4 + ellzcm4^2*m4 + Jrotor1*R1 - 2*...
         L1*L4*m3 - 2*L4*ellzcm1*m1 - 2*L4*ellzcm4*m4 - L4*ellzcmT*mT*...
         cos(q1) + L4*ellycmT*mT*sin(q1) - L1*L2*m3*cos(q1 - q2) + 2*L2*...
         ...
         sin(q1 - q1L) + L4*ellycm2*m2*sin(q1 - q2L) + L4*ellycm3*m3*...
         sin(q1 - q2L) + L4*ellycm4*m4*sin(q1 - q1L);
D(2,2)=Jcm1 + Jcm4 + Jgear1 + Jrotor1*R1^2 + L1^2*m3 + 2*L4^2*...
...
D(2,3)=2*L2*L4*m1*cos(q1 - q2) - L1*L2*m3*cos(q1 - q2) + 2*L2*L4*...
...
D(3,1)=Jcm2 + Jcm3 + Jgear2 + 2*L2^2*m1 + 2*L2^2*m2 + 2*L2^2*...
         ...
         sin(q2 - q2L) + L2*ellycm3*m3*sin(q2 - q2L) + L2*ellycm4*m4*...
         sin(q2 - q1L);
D(3,2)=2*L2*L4*m1*cos(q1 - q2) - L1*L2*m3*cos(q1 - q2) + 2*L2*L4*...
         m2*cos(q1 - q2) + 2*L2*L4*m3*cos(q1 - q2) + L2*L4*m4*...
         cos(q1 - q2) + L2*L4*mH*cos(q1 - q2) + L2*L4*mT*...
         cos(q1 - q2) - L2*ellzcm1*m1*cos(q1 - q2) + L1*ellzcm3*m3*...
         cos(q1 - q2) - L4*ellzcm2*m2*cos(q1 - q2) - L4*ellzcm3*m3*...
...
D(4,1)=Jcm1 + Jcm4 + Jgear1 + L1^2*m3 + ellycm1^2*m1 + ellzcm1^2*...
         ...
         sin(q2 - q1L) + L4*ellycm4*m4*sin(q1 - q1L) - L1*ellycm3*m3*...
         sin(q1L - q2L) + L2*ellycm4*m4*sin(q1L - q2L);
D(4,2)=-L4*(L1*m3*cos(q1 - q1L) + ellzcm1*m1*...
         cos(q1 - q1L) + ellzcm4*m4*cos(q1 - q1L) - ellycm1*m1*...
         sin(q1 - q1L) - ellycm4*m4*sin(q1 - q1L));
D(4,3)=-L2*(L1*m3*cos(q2 - q1L) + ellzcm1*m1*...
         cos(q2 - q1L) + ellzcm4*m4*cos(q2 - q1L) - ellycm1*m1*...
         sin(q2 - q1L) - ellycm4*m4*sin(q2 - q1L));
D(4,4)=Jcm1 + Jcm4 + Jgear1 + Jrotor1*R1^2 + L1^2*m3 + ellycm1^2*...
         m1 + ellzcm1^2*m1 + ellycm4^2*m4 + ellzcm4^2*m4;
D(4,5)=L1*ellzcm3*m3*cos(q1L - q2L) + L2*ellzcm4*m4*...
         cos(q1L - q2L) - L1*ellycm3*m3*sin(q1L - q2L) + L2*ellycm4*m4*...
         sin(q1L - q2L);
D(5,1)=Jcm2 + Jcm3 + Jgear2 + L2^2*m4 + ellycm2^2*m2 + ellzcm2^2*...
         m2 + ellycm3^2*m3 + ellzcm3^2*m3 + Jrotor2*R2 - L2^2*m4*...
         cos(q2 - q2L) - L2*L4*m4*cos(q1 - q2L) - L2*ellzcm2*m2*...
         cos(q2 - q2L) - L4*ellzcm2*m2*cos(q1 - q2L) - L2*ellzcm3*m3*...
         cos(q2 - q2L) - L4*ellzcm3*m3*cos(q1 - q2L) + L1*ellzcm3*m3*...
         ...
         sin(q2 - q2L) + L4*ellycm3*m3*sin(q1 - q2L) - L1*ellycm3*m3*...
         sin(q1L - q2L) + L2*ellycm4*m4*sin(q1L - q2L);
D(5,2)=-L4*(L2*m4*cos(q1 - q2L) + ellzcm2*m2*...
         cos(q1 - q2L) + ellzcm3*m3*cos(q1 - q2L) - ellycm2*m2*...
         sin(q1 - q2L) - ellycm3*m3*sin(q1 - q2L));
D(5,3)=L2*ellycm2*m2*sin(q2 - q2L) - L2*ellzcm2*m2*...
         cos(q2 - q2L) - L2*ellzcm3*m3*cos(q2 - q2L) - L2^2*m4*...
         cos(q2 - q2L) + L2*ellycm3*m3*sin(q2 - q2L);
D(5,4)=L1*ellzcm3*m3*cos(q1L - q2L) + L2*ellzcm4*m4*...
         cos(q1L - q2L) - L1*ellycm3*m3*sin(q1L - q2L) + L2*ellycm4*m4*...
         sin(q1L - q2L);
...
%%%%
C=zeros(5,5)*q(1);
C(1,1)=L2^2*dq2*m4*sin(q2 - q2L) - L2^2*dq2L*m4*...
         ...
         sin(q1 - q2L) - L2*L4*dq1*mH*sin(q1 - q2) + L2*L4*dq2*mH*...
         sin(q1 - q2) - L2*L4*dq1*mT*sin(q1 - q2) + L2*L4*dq2*mT*...
...
C(1,2)=(dq1 + dqT)*(L4*ellycmT*mT*cos(q1) + L4*ellzcmT*mT*...
         ...
         sin(q1 - q2L) - L2*L4*mH*sin(q1 - q2) - L2*L4*mT*...
         sin(q1 - q2) - L2*ellycm1*m1*cos(q1 - q2) - L1*ellycm3*m3*...
         cos(q1 - q2) + L4*ellycm2*m2*cos(q1 - q2) + L4*ellycm3*m3*...
         cos(q1 - q2) + L4*ellycm1*m1*cos(q1 - q1L) + L4*ellycm2*m2*...
         cos(q1 - q2L) + L4*ellycm3*m3*cos(q1 - q2L) + L4*ellycm4*m4*...
         cos(q1 - q1L) + L2*ellzcm1*m1*sin(q1 - q2) - L1*ellzcm3*m3*...
         sin(q1 - q2) + L4*ellzcm2*m2*sin(q1 - q2) + L4*ellzcm3*m3*...
         sin(q1 - q2) + L4*ellzcm1*m1*sin(q1 - q1L) + L4*ellzcm2*m2*...
         sin(q1 - q2L) + L4*ellzcm3*m3*sin(q1 - q2L) + L4*ellzcm4*m4*...
         sin(q1 - q1L));
C(1,3)=(dq2 + dqT)*(L2^2*m4*sin(q2 - q2L) + L2*ellycmT*mT*...
         ...
         sin(q2 - q1L) + L2*L4*mH*sin(q1 - q2) + L2*L4*mT*...
         sin(q1 - q2) + L2*ellycm1*m1*cos(q1 - q2) + L1*ellycm3*m3*...
         cos(q1 - q2) - L4*ellycm2*m2*cos(q1 - q2) - L4*ellycm3*m3*...
         cos(q1 - q2) + L2*ellycm1*m1*cos(q2 - q1L) + L2*ellycm2*m2*...
         cos(q2 - q2L) + L2*ellycm3*m3*cos(q2 - q2L) + L2*ellycm4*m4*...
         cos(q2 - q1L) - L2*ellzcm1*m1*sin(q1 - q2) + L1*ellzcm3*m3*...
         sin(q1 - q2) - L4*ellzcm2*m2*sin(q1 - q2) - L4*ellzcm3*m3*...
         sin(q1 - q2) + L2*ellzcm1*m1*sin(q2 - q1L) + L2*ellzcm2*m2*...
         sin(q2 - q2L) + L2*ellzcm3*m3*sin(q2 - q2L) + L2*ellzcm4*m4*...
         sin(q2 - q1L));
C(1,4)=-(dq1L + dqT)*(L1*L2*m3*sin(q2 - q1L) + L1*L4*m3*...
         ...
         sin(q1L - q2L));
C(1,5)=-(dq2L + dqT)*(L2^2*m4*sin(q2 - q2L) + L2*L4*m4*...
         ...
         sin(q1L - q2L));
C(2,1)=2*L2*L4*dq2*m1*sin(q1 - q2) - L4*dqT*ellzcmT*mT*...
         ...
         sin(q1 - q2L) + L2*L4*dq2*mH*sin(q1 - q2) + L2*L4*dqT*mH*...
         sin(q1 - q2) + L2*L4*dq2*mT*sin(q1 - q2) + L2*L4*dqT*mT*...
...
C(2,3)=(dq2 + dqT)*(2*L2*L4*m1*sin(q1 - q2) - L1*L2*m3*...
         sin(q1 - q2) + 2*L2*L4*m2*sin(q1 - q2) + 2*L2*L4*m3*...
         sin(q1 - q2) + L2*L4*m4*sin(q1 - q2) + L2*L4*mH*...
         sin(q1 - q2) + L2*L4*mT*sin(q1 - q2) + L2*ellycm1*m1*...
         cos(q1 - q2) + L1*ellycm3*m3*cos(q1 - q2) - L4*ellycm2*m2*...
         cos(q1 - q2) - L4*ellycm3*m3*cos(q1 - q2) - L2*ellzcm1*m1*...
         sin(q1 - q2) + L1*ellzcm3*m3*sin(q1 - q2) - L4*ellzcm2*m2*...
         sin(q1 - q2) - L4*ellzcm3*m3*sin(q1 - q2));
C(2,4)=-L4*(dq1L + dqT)*(L1*m3*sin(q1 - q1L) + ellycm1*m1*...
         cos(q1 - q1L) + ellycm4*m4*cos(q1 - q1L) + ellzcm1*m1*...
         sin(q1 - q1L) + ellzcm4*m4*sin(q1 - q1L));
C(2,5)=-L4*(dq2L + dqT)*(L2*m4*sin(q1 - q2L) + ellycm2*m2*...
         cos(q1 - q2L) + ellycm3*m3*cos(q1 - q2L) + ellzcm2*m2*...
         sin(q1 - q2L) + ellzcm3*m3*sin(q1 - q2L));
C(3,1)=L1*L2*dq1*m3*sin(q1 - q2) - L2^2*dqT*m4*...
         ...
         sin(q2 - q1L) - L2*L4*dq1*mH*sin(q1 - q2) - L2*L4*dqT*mH*...
         sin(q1 - q2) - L2*L4*dq1*mT*sin(q1 - q2) - L2*L4*dqT*mT*...
...
C(3,2)=-(dq1 + dqT)*(2*L2*L4*m1*sin(q1 - q2) - L1*L2*m3*...
         sin(q1 - q2) + 2*L2*L4*m2*sin(q1 - q2) + 2*L2*L4*m3*...
         sin(q1 - q2) + L2*L4*m4*sin(q1 - q2) + L2*L4*mH*...
         sin(q1 - q2) + L2*L4*mT*sin(q1 - q2) + L2*ellycm1*m1*...
         cos(q1 - q2) + L1*ellycm3*m3*cos(q1 - q2) - L4*ellycm2*m2*...
...
C(4,2)=L4*(dq1 + dqT)*(L1*m3*sin(q1 - q1L) + ellycm1*m1*...
         cos(q1 - q1L) + ellycm4*m4*cos(q1 - q1L) + ellzcm1*m1*...
         sin(q1 - q1L) + ellzcm4*m4*sin(q1 - q1L));
C(4,3)=L2*(dq2 + dqT)*(L1*m3*sin(q2 - q1L) + ellycm1*m1*...
         cos(q2 - q1L) + ellycm4*m4*cos(q2 - q1L) + ellzcm1*m1*...
         sin(q2 - q1L) + ellzcm4*m4*sin(q2 - q1L));
C(4,5)=(dq2L + dqT)*(L1*ellycm3*m3*cos(q1L - q2L) - L2*ellycm4*...
         m4*cos(q1L - q2L) + L1*ellzcm3*m3*sin(q1L - q2L) + L2*ellzcm4*m4*...
         sin(q1L - q2L));
C(5,1)=L2^2*dq2*m4*sin(q2 - q2L) + L2^2*dqT*m4*...
         ...
         sin(q1L - q2L) - L2*dqT*ellzcm4*m4*sin(q1L - q2L);
C(5,2)=L4*(dq1 + dqT)*(L2*m4*sin(q1 - q2L) + ellycm2*m2*...
         cos(q1 - q2L) + ellycm3*m3*cos(q1 - q2L) + ellzcm2*m2*...
         sin(q1 - q2L) + ellzcm3*m3*sin(q1 - q2L));
C(5,3)=L2*(dq2 + dqT)*(L2*m4*sin(q2 - q2L) + ellycm2*m2*...
         cos(q2 - q2L) + ellycm3*m3*cos(q2 - q2L) + ellzcm2*m2*...
         sin(q2 - q2L) + ellzcm3*m3*sin(q2 - q2L));
C(5,4)=-(dq1L + dqT)*(L1*ellycm3*m3*cos(q1L - q2L) - L2*ellycm4*...
         m4*cos(q1L - q2L) + L1*ellzcm3*m3*sin(q1L - q2L) + L2*ellzcm4*m4*...
         sin(q1L - q2L));
%%%%
%%%%
...
%%%%
G=zeros(5,1)*q(1);
G(1)=g*(ellycmT*mT*cos(qT) - ellzcmT*mT*sin(qT) - L1*m3*...
         ...
         sin(q1L + qT));
G(2)=g*(2*L4*m1*sin(q1 + qT) - L1*m3*sin(q1 + qT) + 2*L4*m2*...
...
G(3)=g*(2*L2*m1*sin(q2 + qT) + 2*L2*m2*sin(q2 + qT) + 2*L2*m3*...
...
%%%%
%%%%
B_HarmonicDrive=zeros(5,4)*q(1);
B_HarmonicDrive(2,1)=1;
B_HarmonicDrive(3,2)=1;
B_HarmonicDrive(4,3)=1;
B_HarmonicDrive(5,4)=1;
%%%%
%%%%
end