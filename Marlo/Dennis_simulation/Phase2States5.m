function [nlp, x1, xdot1, u1, t1, F1, g1_final, dxe1, Fe1] =...
		Phase2States5(nlp,sys, height, lb0, ub0, kf, phaseN, stepLength)
...
nlp.addConstraint(0.1, g1(4), 0.3); % Apply ground clearance constraint

[g1, ~, ~] = sys.constraintEquation(x1.ind(7), xdot1.ind(7), 'ds');  % Get position of swing leg toe
nlp.addConstraint(0, g1(4), 0.3); % Apply ground clearance constraint
