...
nlp.addConstraint(lb0+height,g1_final(4)-g1_final(2),ub0+height); % final step height
...
nlp.addConstraint(0, Fe1(2), 15-5); % Positive vertical force must be positive
...
% nlp.addConstraint(0.1, g1(4), 0.4);
% % 
[g1, ~, ~] = sys.constraintEquation(x1.ind(2), xdot1.ind(2), 'ds');  % Get position of swing leg toe
nlp.addConstraint(0.27, g1(4), 0.4);

[g1, ~, ~] = sys.constraintEquation(x1.ind(16), xdot1.ind(16), 'ds');  % Get position of swing leg toe
nlp.addConstraint(0.25, g1(4), 0.4);
...
%% save parameters
%% l0=40; l1=70; h0=-25; h1=25;
% % [g1, ~, ~] = sys.constraintEquation(x1.ind(2), xdot1.ind(2), 'ds');  % Get position of swing leg toe
% % nlp.addConstraint(0.27, g1(4), 0.4);
% % 
% % [g1, ~, ~] = sys.constraintEquation(x1.ind(16), xdot1.ind(16), 'ds');  % Get position of swing leg toe
% % nlp.addConstraint(0.25, g1(4), 0.4);
%% l0=70; l1=40; h0=-25; h1=25;
%% l0=40; l1=40; h0=-25; h1=25;
%% l0=70; l1=70; h0=-25; h1=25;
% % [g1, ~, ~] = sys.constraintEquation(x1.ind(2), xdot1.ind(2), 'ds');  % Get position of swing leg toe
% % nlp.addConstraint(0.27, g1(4), 0.4);
% % 
% % [g1, ~, ~] = sys.constraintEquation(x1.ind(18), xdot1.ind(18), 'ds');  % Get position of swing leg toe
% % nlp.addConstraint(0.28, g1(4), 0.4);
%% l0=40; l1=70; h0=25; h1=-25;
% (also need to change kf=0.2)
% Non stance foot ground clearance
% % [g1, ~, ~] = sys.constraintEquation(x1.ind(10), xdot1.ind(10), 'ds');  % Get position of swing leg toe
% % nlp.addConstraint(0.1, g1(4), 0.4);
% % % % 
% % [g1, ~, ~] = sys.constraintEquation(x1.ind(6), xdot1.ind(6), 'ds');  % Get position of swing leg toe
% % nlp.addConstraint(0.0, g1(4), 0.4);
% % 
...
% % nlp.addConstraint(-0.0, g1(4), 0.4);
% % 
% % [g1, ~, ~] = sys.constraintEquation(x1.ind(14), xdot1.ind(14), 'ds');  % Get position of swing leg toe
% % nlp.addConstraint(0.07, g1(4), 0.4);
%% l0=40; l1=40; h0=25; h1=-25;
% Non stance foot ground clearance
% % [g1, ~, ~] = sys.constraintEquation(x1.ind(10), xdot1.ind(10), 'ds');  % Get position of swing leg toe
% % nlp.addConstraint(0.1, g1(4), 0.4);
% % % % 
% % [g1, ~, ~] = sys.constraintEquation(x1.ind(6), xdot1.ind(6), 'ds');  % Get position of swing leg toe
% % nlp.addConstraint(0.02, g1(4), 0.4);
% % 
% % [g1, ~, ~] = sys.constraintEquation(x1.ind(14), xdot1.ind(14), 'ds');  % Get position of swing leg toe
% % nlp.addConstraint(0, g1(4), 0.4);
%% l0=70; l1=70; h0=25; h1=-25;
% Non stance foot ground clearance
% % [g1, ~, ~] = sys.constraintEquation(x1.ind(10), xdot1.ind(10), 'ds');  % Get position of swing leg toe
% % nlp.addConstraint(0.1, g1(4), 0.4);
...
% % nlp.addConstraint(0.02, g1(4), 0.4);
% % 
% % [g1, ~, ~] = sys.constraintEquation(x1.ind(12), xdot1.ind(12), 'ds');  % Get position of swing leg toe
% % nlp.addConstraint(0, g1(4), 0.4);
%% l0=40; l1=70; h0=-25; h1=-25;
% (also need to change kf = 0.2 and tauLim = 5 % Actuator torque limit  )
% Non stance foot ground clearance
% % [g1, ~, ~] = sys.constraintEquation(x1.ind(10), xdot1.ind(10), 'ds');  % Get position of swing leg toe
% % nlp.addConstraint(0.1, g1(4), 0.4);
% % % 
% % [g1, ~, ~] = sys.constraintEquation(x1.ind(3), xdot1.ind(3), 'ds');  % Get position of swing leg toe
% % nlp.addConstraint(0.27, g1(4), 0.4);
%% l0=70; l1=40; h0=-25; h1=-25;
% Non stance foot ground clearance
% % [g1, ~, ~] = sys.constraintEquation(x1.ind(10), xdot1.ind(10), 'ds');  % Get position of swing leg toe
% % nlp.addConstraint(0.15, g1(4), 0.4);
% % % 
% % [g1, ~, ~] = sys.constraintEquation(x1.ind(2), xdot1.ind(2), 'ds');  % Get position of swing leg toe
% % nlp.addConstraint(0.27, g1(4), 0.4);
% % 
...
% % nlp.addConstraint(0, g1(4), 0.4);
%% l0=40; l1=40; h0=-25; h1=-25; 
% (Slow down and stop after 4 steps)
% Non stance foot ground clearance
% % [g1, ~, ~] = sys.constraintEquation(x1.ind(10), xdot1.ind(10), 'ds');  % Get position of swing leg toe
% % nlp.addConstraint(0.15, g1(4), 0.4);
% % % 
...
%% l0=40; l1=70; h0=25; h1=25;
% Non stance foot ground clearance
% % [g1, ~, ~] = sys.constraintEquation(x1.ind(9), xdot1.ind(9), 'ds');  % Get position of swing leg toe
% % nlp.addConstraint(0.1, g1(4), 0.4);
% % 
% % [g1, ~, ~] = sys.constraintEquation(x1.ind(5), xdot1.ind(5), 'ds');  % Get position of swing leg toe
% % nlp.addConstraint(0.05, g1(4), 0.4);
% % 
% % [g1, ~, ~] = sys.constraintEquation(x1.ind(13), xdot1.ind(13), 'ds');  % Get position of swing leg toe
% % nlp.addConstraint(0.28, g1(4), 0.6);
%% l0=70; l1=40; h0=25; h1=25;
% Non stance foot ground clearance
% % [g1, ~, ~] = sys.constraintEquation(x1.ind(11), xdot1.ind(11), 'ds');  % Get position of swing leg toe
% % nlp.addConstraint(0.1, g1(4), 0.4);
% % 
...
% % 
% % [g1, ~, ~] = sys.constraintEquation(x1.ind(14), xdot1.ind(14), 'ds');  % Get position of swing leg toe
% % nlp.addConstraint(0.25, g1(4), 0.6);
%% l0=70; l1=70; h0=25; h1=25;
% Non stance foot ground clearance
% % [g1, ~, ~] = sys.constraintEquation(x1.ind(10), xdot1.ind(10), 'ds');  % Get position of swing leg toe
% % nlp.addConstraint(0.1, g1(4), 0.4);
...
% % nlp.addConstraint(0, g1(4), 0.4);
% % 
% % [g1, ~, ~] = sys.constraintEquation(x1.ind(15), xdot1.ind(15), 'ds');  % Get position of swing leg toe
% % nlp.addConstraint(0.28, g1(4), 0.6);
