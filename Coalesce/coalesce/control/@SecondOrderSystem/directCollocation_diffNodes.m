function [nlp,xddot1,xddot2,xddot3,xddot4,xddot5,xddot6] = directCollocation_diffNodes(obj, nNodes, varargin)
...
% 			'Length', nNodes);
        ...
        elseif im == 5
            xddot5 = nlp.addVariable(zeros(numel(f), 1), -Inf(numel(f), 1), Inf(numel(f), 1), ...
                ...
                xddot = xddot5;
        elseif im == 6
            xddot6 = nlp.addVariable(zeros(numel(f), 1), -Inf(numel(f), 1), Inf(numel(f), 1), ...
                'Description', 'State Slack', ...
                    'Length', nNodes);
                xddot = xddot6;
        else
